...
#define ADDRESS "42:F5:20:27:3A:8B" //Endereço do iTag, conseguido pelo próprio scan
#define RELAY_PIN 2 //Pino do Relê
#define SCAN_INTERVAL 2000 //intervalo entre cada scan
#define TARGET_RSSI -20 //RSSI limite para ligar o relê.
#define MAX_MISSING_TIME 2000 //Tempo para desligar o relê desde o momento que o iTag não for encontrado
